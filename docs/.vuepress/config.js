  ...
  themeConfig: {
    ...
    sidebar: [
      ...
      },
      {
        ...
        path: "/nodejs",
        collapsable: false, // 不折叠
        children: [{ title: "异步式IO", path: "/nodejs/异步式io.md" }],
      },
      {
        title: "算法",
        path: "/algorithm",
      ...
      },
      {
        ...
        children: [
          ...
          { title: "getElementsByStyle", path: "/GFE/12.getElementsByStyle/" },
          {
            ...
            path: "/GFE/13.Function.prototype.call/",
          },
      ...
      },
      {
        ...
        children: [
          { title: "Balanced Brackets", path: "/Blind/01.Balanced Brackets/" },
          {
            ...
            path: "/Blind/02.Find Duplicates in Array/",
          },
          {
            title: "Find Missing Number in Sequence",
            path: "/Blind/03.Find Missing Number in Sequence/",
          },
        ],
      },
      {
